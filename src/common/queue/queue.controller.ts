...
import {
  RequeueDeadLetterQueryDto,
  WarmSessionQueryDto,
} from "./dto/queue-requests.dto";
import {
...
export class QueueController {
  ...
  @ApiResponse({
    status: 200,
    description: "Queue health retrieved",
  ...
  @ApiResponse({
    status: 200,
    description: "Queue lag metrics retrieved",
    type: QueueLagResponseDto,
  })
  @AppErrorResponse(
    401,
    "Unauthorized",
  ...
  @ApiResponse({
    status: 201,
    description: "Jobs requeued successfully",
    type: RequeueDeadLetterResponseDto,
  })
  @AppErrorResponse(
    401,
    "Unauthorized",
    "POST",
    "/api/ops/queues/dead-letter/requeue",
    "Invalid or missing access token",
  )
  ...
  @ApiResponse({
    status: 201,
    description: "Session caches warmed",
    type: WarmSessionResponseDto,
  })
  @AppErrorResponse(
    401,
    "Unauthorized",
    "POST",
    "/api/ops/queues/warm/session",
    "Invalid or missing access token",
  )
